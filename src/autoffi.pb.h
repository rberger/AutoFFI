...
class Export;
class ExportDefaultTypeInternal;
extern ExportDefaultTypeInternal _Export_default_instance_;
class RecordField;
class RecordFieldDefaultTypeInternal;
extern RecordFieldDefaultTypeInternal _RecordField_default_instance_;
class Type;
...
class RecordField : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:autoffi.proto.RecordField) */ {
 public:
  ...
  static inline const RecordField* internal_default_instance() {
    return reinterpret_cast<const RecordField*>(
  ...
  inline RecordField* New() const PROTOBUF_FINAL { return New(NULL); }

  RecordField* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  friend struct  protobuf_autoffi_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class Export : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:autoffi.proto.Export) */ {
 public:
  ...
  static inline const Export* internal_default_instance() {
    return reinterpret_cast<const Export*>(
  ...
  inline Export* New() const PROTOBUF_FINAL { return New(NULL); }

  Export* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
class Catalog : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:autoffi.proto.Catalog) */ {
 public:
  ...
  inline Catalog* New() const PROTOBUF_FINAL { return New(NULL); }

  Catalog* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
